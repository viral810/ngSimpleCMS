...
namespace PHPCRProxies\__CG__\Acme\BasicCmsBundle\Document;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Page extends \Acme\BasicCmsBundle\Document\Page implements \Doctrine\Common\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'children', 'id', 'parent', 'title', 'content', 'routes');
        }
