 ...
 */
class Post extends \Acme\BasicCmsBundle\Document\Post implements \Doctrine\Common\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'date', 'id', 'parent', 'title', 'content', 'routes');
        }
